    ...
    <tr>
        <td colspan="2">
            <div style="height: 110px;" class="bg-blue-400 ">
                ...
                {{--                <div style="text-align: center;width: 100%;" class="gst">{{$cmp->get('gstCell')}}</div>--}}
            </div>
        </td>
    </tr>
    <tr>
        <td colspan="2" style="  background-color: darkgray">
            <div style=" height: 25px;text-align: center;  vertical-align: middle; color: white; font-size: large  ">TAX
                INVOICE
